<script lang="ts">
  ...
  import { getImagesFromWNFS, type Image } from '$routes/upload-test/lib/gallery'
  // import FileUploadCard from '$routes/upload-test/components/upload/FileUploadCard.svelte'
  import ImageCard from '$routes/upload-test/components/imageGallery/ImageCard.svelte'
  import ImageModal from '$routes/upload-test/components/imageGallery/ImageModal.svelte'
